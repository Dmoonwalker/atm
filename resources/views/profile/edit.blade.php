                                ...
                                <script>
                                    ...
                                    function updateLGAs(selectedState) {
                                        ...
                                        if (stateObj && stateObj.lgas && Array.isArray(stateObj.lgas)) {
                                            console.log('LGAs for state:', stateObj.lgas);
                                    ...
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        initBioChangeDetection();
                                        setupPhoneEdit();
                                    });

                                    // Bio-specific change detection
                                    function initBioChangeDetection() {
                                        ...
                                        // Function to check if bio has changed
                                        function checkBioChanges() {
                                            const currentBio = bioTextarea.value;
                                            const bioChanged = currentBio !== originalBio;
                                        ...
                                        // Add event listeners to bio field only
                                        bioTextarea.addEventListener('input', checkBioChanges);
                                        bioTextarea.addEventListener('change', checkBioChanges);
                                        bioTextarea.addEventListener('keyup', checkBioChanges);
                                        ...
                                        form.addEventListener('submit', function(e) {
                                            if (!saveButton.disabled) {
                                                ...
                                                saveButton.classList.add('bg-emerald-400');
                                                saveButton.innerHTML = `
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea id="bio" name="bio" rows="4"
                                            class="mt-1 block w-full border-gray-300 focus:border-emerald-500 focus:ring-emerald-500 rounded-md shadow-sm transition-all duration-200"
                                            placeholder="Tell us about yourself...">{{ old('bio', $user->bio) }}</textarea>
                                        <div class="mt-2 flex items-center justify-between">
                                            <p class="text-sm text-gray-500">Share a brief description about yourself, your interests, or your business.</p>
                                            <div class="text-xs text-gray-400 flex items-center">
                                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                </svg>
                                                Changes here will enable save
                                            </div>
                                        </div>
